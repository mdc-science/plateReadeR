...
If you use this workflow, please cite it — see [`CITATION.cff`](CITATION.cff) (GitHub renders a "Cite this repository" button from it), or use the DOI directly: [10.5281/zenodo.21933797](https://doi.org/10.5281/zenodo.21933797). That DOI always resolves to the latest version; the citable snapshot of v1.2.1 specifically is [10.5281/zenodo.21980171](https://doi.org/10.5281/zenodo.21980171) (v1.2.0: [10.5281/zenodo.21980063](https://doi.org/10.5281/zenodo.21980063), v1.1.0: [10.5281/zenodo.21937604](https://doi.org/10.5281/zenodo.21937604), v1.0.0: [10.5281/zenodo.21933798](https://doi.org/10.5281/zenodo.21933798)).
